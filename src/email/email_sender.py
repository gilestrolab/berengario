    ...
    if settings.email_custom_footer_file and settings.email_custom_footer_file.exists():
        try:
            ...
            if footer_text:
                ...
                html_footer = f'<div class="footer">{footer_text.replace(chr(10), "<br>")}</div>'

                logger.info(f"Loaded custom footer from {settings.email_custom_footer_file}")
...
def format_response_email(
    ...
    if email_format == "text":
        ...
        plain_text, html_body = _format_text_email(
