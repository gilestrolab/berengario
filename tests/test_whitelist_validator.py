...
@pytest.fixture
def mock_settings():
    """Mock settings for whitelist configuration."""
    with patch("src.email.whitelist_validator.settings") as mock:
        mock.email_whitelist = ""
        mock.email_whitelist_file = None
        mock.email_whitelist_enabled = True
        yield mock
...
class TestWhitelistValidator:
    ...
    def test_init_with_inline_emails(self, mock_settings):
    ...
    def test_init_with_inline_domains(self, mock_settings):
    ...
    def test_init_with_mixed_inline(self, mock_settings):
    ...
    def test_init_with_file(self, mock_settings):
    ...
    def test_init_with_invalid_entries(self, mock_settings):
    ...
    def test_is_allowed_disabled(self, mock_settings):
    ...
    def test_is_allowed_exact_match(self, mock_settings):
    ...
    def test_is_allowed_domain_match(self, mock_settings):
    ...
    def test_is_allowed_mixed_whitelist(self, mock_settings):
    ...
    def test_is_allowed_empty_email(self, mock_settings):
    ...
    def test_is_allowed_empty_whitelist(self, mock_settings):
    ...
    def test_is_allowed_whitespace_handling(self, mock_settings):
        """Test is_allowed handles whitespace correctly."""
        validator = WhitelistValidator(whitelist="alice@example.com")

        assert validator.is_allowed("  alice@example.com  ") is True

    def test_add_entry_email(self, mock_settings):
    ...
    def test_add_entry_domain(self, mock_settings):
    ...
    def test_add_entry_duplicate(self, mock_settings):
    ...
    def test_add_entry_invalid(self, mock_settings):
    ...
    def test_remove_entry_email(self, mock_settings):
    ...
    def test_remove_entry_domain(self, mock_settings):
    ...
    def test_remove_entry_not_found(self, mock_settings):
    ...
    def test_get_whitelist_summary(self, mock_settings):
    ...
    def test_get_whitelist_summary_disabled(self, mock_settings):
    ...
    def test_case_insensitive_domains(self, mock_settings):
    ...
    def test_file_not_found(self, mock_settings):
    ...
    def test_combined_file_and_inline(self, mock_settings):
